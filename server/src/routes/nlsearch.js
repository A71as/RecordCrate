...
router.post('/natural-language', async (req, res) => {
  try {
    ...
    // Process with Gemini
    const geminiResponse = await geminiService.processNaturalLanguageQuery(query);

    // Generate search suggestions
    const searchSuggestions = await geminiService.generateSearchSuggestions(geminiResponse);
